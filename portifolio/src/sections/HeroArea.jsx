...
function HeroArea() {
  return (
    <section
      id="home"
      className="h-fit flex flex-col lg:flex-row items-center justify-between pb-[80px] sm:pb-[140px] 2xl:px-10"
    >
      {/* ESQUERDA */}
      ...
      <div className="z-2 flex-1 h-[100%] mt-[50px]">
        <div className="flex justify-center items-center">
          <img className="sm:max-w-[550px]" src="/Main Hero.png" alt="" />
        </div>
      </div>
    </section>
  );
